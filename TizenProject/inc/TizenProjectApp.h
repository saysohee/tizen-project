#ifndef _TIZEN_PROJECT_APP_H_
#define _TIZEN_PROJECT_APP_H_
...
//  The [TizenProject]App class must inherit from the UiApp class,
//  which provides the basic features necessary to define a UI application.
 
class TizenProjectApp
...
public:
	...
	TizenProjectApp(void);
	virtual ~TizenProjectApp(void);
